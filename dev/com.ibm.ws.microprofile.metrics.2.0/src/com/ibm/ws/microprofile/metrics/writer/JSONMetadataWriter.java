...
public class JSONMetadataWriter implements OutputWriter {
    ...
    protected JSONObject getJsonFromObject(Metadata metadata) {
        ...
        jsonObject.put("description", Tr.formatMessage(tc, locale, sanitizeMetadata(metadata.getDescription().orElse(null))));
        jsonObject.put("type", sanitizeMetadata(metadata.getType()));
        jsonObject.put("unit", sanitizeMetadata(metadata.getUnit().orElse(null)));
